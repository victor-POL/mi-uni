...
import { ArrowLeft, Home, BookOpen, Calendar, GraduationCap, User, Menu, X } from "lucide-react"
...
export const AppHeader: React.FC<AppHeaderProps> = ({ title = "-", showBackButton = true, backHref }) => {
  ...
  const visibleNavItems = navigationItems.filter((item) => item.public || (isInitialized && user))
