...
export function EditarNotasMateriaModal({ isOpen, onClose, materia, onSuccess }: EditarNotasMateriaModalProps) {
    ...
    try {
      const response = await fetch('/api/user/materias-en-curso/', {
        ...
        body: JSON.stringify({
          ...
          notaRecuperatorioPrimerParcial: formData.notaRecuperatorioPrimerParcial
            ? parseFloat(formData.notaRecuperatorioPrimerParcial)
            : null,
          notaRecuperatorioSegundoParcial: formData.notaRecuperatorioSegundoParcial
            ? parseFloat(formData.notaRecuperatorioSegundoParcial)
            : null,
        }),
      })
