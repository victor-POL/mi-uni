            ...
            <CardContent className="space-y-6">
              ...
              {!signInMethods.includes('password') && (
                <div className="space-y-4">
                  ...
                  <Button onClick={handleLinkEmailPassword} disabled={!!loading || !passwordForLink} className="w-full">
              ...
              {signInMethods.includes('password') && signInMethods.includes('github.com') && (
                <div className="text-center py-4">
                  ...
                  <p className="text-sm text-gray-500 mt-1">Puedes iniciar sesión con email/password o con GitHub</p>
                </div>
              )}
            </CardContent>
          </Card>
